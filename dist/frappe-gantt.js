	...
	*/
	...
	function Octogon(gt, task) {
		...
		function drawInnerOctogon() {
			...
			self.$barOct = gt.canvas.polygon(Snap.format("{oct.x1},{oct.y1} {oct.x2},{oct.y2} {oct.x3},{oct.y2} {oct.x4},{oct.y4} {oct.x4},{oct.y5} {oct.x3},{oct.y6} {oct.x2},{oct.y6} {oct.x1},{oct.y5}", oct)).addClass('bar').appendTo(self.$bar);
		}
	
		function updateInnerOctogon(w) {
			setPolygon(w);
			var pts = Snap.format("{oct.x1},{oct.y1} {oct.x2},{oct.y2} {oct.x3},{oct.y2} {oct.x4},{oct.y4} {oct.x4},{oct.y5} {oct.x3},{oct.y6} {oct.x2},{oct.y6} {oct.x1},{oct.y5}", oct).replace(/ /g, ',').split(',');
